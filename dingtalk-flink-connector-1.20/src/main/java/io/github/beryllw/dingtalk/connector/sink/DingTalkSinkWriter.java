...
import io.github.beryllw.dingtalk.connector.client.DingTalkApiClient;
import io.github.beryllw.dingtalk.connector.client.DingTalkClient;
import io.github.beryllw.dingtalk.connector.client.DingTalkWebhookClient;
...
public class DingTalkSinkWriter<InputT>
    ...
    protected void submitRequestEntries(
            ...
            ResultHandler<String> resultHandler) {
        ...
        if (!failed.isEmpty()) {
            ...
            resultHandler.retryForEntries(failed);
        } else {
