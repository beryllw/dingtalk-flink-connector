...
生成的 shaded JAR 位于：
- `dingtalk-flink-connector-1.20/target/dingtalk-flink-connector-1.20-1.0.0-SNAPSHOT.jar`（适用于 Flink 1.20）
- `dingtalk-flink-connector-2.2/target/dingtalk-flink-connector-2.2-1.0.0-SNAPSHOT.jar`（适用于 Flink 2.2）
